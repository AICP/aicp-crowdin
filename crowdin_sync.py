...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Synchronising AICP's translations with Crowdin"
    )
    parser.add_argument("-u", "--username", help="Gerrit username")
    parser.add_argument("-b", "--branch", help="AICP branch", required=True)
    parser.add_argument("-c", "--config", help="Custom (yaml) config file")
    parser.add_argument(
    ...
    parser.add_argument(
        "--unzip", nargs="+", help="Specify a translation zip file to treat like a download"
    )
